...
final class Version20250823130552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE email_confirmation (id INT NOT NULL DEFAULT nextval(\'email_confirmation_id_seq\'), creator_id INT DEFAULT NULL, email VARCHAR(255) NOT NULL, params TEXT DEFAULT NULL, expiry_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, verification_handler VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
