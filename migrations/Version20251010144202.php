...
final class Version20251010144202 extends AbstractMigration
{
    ...
    {
        return 'Create custom_time_window table';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE custom_time_window (id UUID NOT NULL, schedule_id INT NOT NULL, date DATE NOT NULL, start_time TIME(0) WITHOUT TIME ZONE NOT NULL, end_time TIME(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_ED6B83F7A40BC2D5 ON custom_time_window (schedule_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE custom_time_window');
