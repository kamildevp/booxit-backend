...
class OrganizationMemberScheduleAssignmentListQueryDTO extends AbstractDTO implements ListQueryDTOInterface
{
    use PaginationFieldsDTO, OrderFieldsDTO;

    public function __construct(
        #[Assert\Valid]
        public readonly OrganizationMemberScheduleAssignmentListFiltersDTO $filters = new OrganizationMemberScheduleAssignmentListFiltersDTO(),
        int $page = 1,
    ...
    {
        return ['schedule.name', 'access_type'];
    }
}