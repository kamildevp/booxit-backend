...
class ScheduleReservationListQueryDTO extends AbstractDTO implements ListQueryDTOInterface
{
    use PaginationFieldsDTO, OrderFieldsDTO;

    public function __construct(
        #[Assert\Valid]
        public readonly ?ScheduleReservationListFiltersDTO $filters = null,
        int $page = 1,
    ...
    {
        return array_merge(TimestampsColumns::values(), ['reference', 'email', 'verified', 'expiry_date', 'estimated_price', 'start_date_time', 'end_date_time', 'type', 'status']);
    }
}