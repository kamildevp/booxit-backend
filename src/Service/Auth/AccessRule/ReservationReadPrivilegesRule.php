...
class ReservationReadPrivilegesRule implements AccessRuleInterface
{
    ...
    public function validateAccess(?UserInterface $user, Request $request): void
    {
        ...
        if(!$actionMember || ($actionMember->getRole() != OrganizationRole::ADMIN->value && !$scheduleAssignment))
        {
