...
class ReservationAuthDataProvider extends BaseDataProvider 
{
    ...
    public static function protectedPaths()
    {
        return [
            ...
            ['/api/reservations/{reservation}/cancel', 'POST'],
    ...
    public static function privilegesOnlyPaths()
    {
        return [
            ...
            ['/api/reservations/{reservation}/cancel', 'POST', 'user1@example.com'],
            ['/api/reservations/{reservation}/cancel', 'POST', 'om-user1@example.com'],
            ['/api/reservations/{reservation}/cancel', 'POST', 'sa-user2@example.com'],
